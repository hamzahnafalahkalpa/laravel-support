...
class Activity extends BaseModel
{
    ...
    protected $fillable   = [
      'id','activity_flag','reference_type','reference_id','props',
    ...
    //EIGER SECTION
    public function reference(){return $this->morphTo(__FUNCTION__);}
    public function activityStatus(){return $this->hasOneModel('ActivityStatus');}
    public function activityStatuses(){return $this->hasManyModel('ActivityStatus');}
    //END EIGER SECTION
}
